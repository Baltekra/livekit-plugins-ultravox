...
class _UltravoxOptions:
    ...
    native_tools: NotGivenOr[list[dict[str, Any]]]
    metadata: NotGivenOr[dict[str, Any]]
    inactivity_messages: NotGivenOr[list[dict[str, Any]]]
    vad_settings: NotGivenOr[dict[str, Any]]
    recording_enabled: NotGivenOr[bool]
...
class RealtimeModel(llm.RealtimeModel):
    ...
    def __init__(
        ...
        *,
        ...
        native_tools: list[dict[str, Any]] = NOT_GIVEN,
        metadata: dict[str, Any] = NOT_GIVEN,
        inactivity_messages: list[dict[str, Any]] = NOT_GIVEN,
        vad_settings: dict[str, Any] = NOT_GIVEN,
        recording_enabled: bool = NOT_GIVEN,
    ) -> None:
        ...
        # self._opts.native_tools = native_tools or []
        # self._opts.metadata = metadata or {}
        # self._opts.inactivity_messages = inactivity_messages or []
        # self._opts.vad_settings = vad_settings or {}
    ...
    async def _main_task(self) -> None:
        ...
        while not self._msg_ch.closed:
            ...
            try:
                ...
                if is_given(self._realtime_model._opts.metadata):
                    payload["metadata"] = self._realtime_model._opts.metadata
                if is_given(self._realtime_model._opts.inactivity_messages):
                    payload["inactivityMessages"] = self._realtime_model._opts.inactivity_messages
                if is_given(self._realtime_model._opts.vad_settings):
                    payload["vadSettings"] = self._realtime_model._opts.vad_settings
                if is_given(self._realtime_model._opts.recording_enabled):
                    payload["recordingEnabled"] = self._realtime_model._opts.recording_enabled
